...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    "date-picker": vuejs_datepicker__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  ...
  methods: {
    loadData: function loadData() {
      ...
      axios.get(this.urlEvent + "/" + this.currentMonth).then(function (response) {
        _this2.calendarEvents = response.data.map(function (x) {
    ...
    actionModal: function actionModal(event) {
      this.form = event;
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c(
        "h5",
        { staticClass: "modal-title", attrs: { id: "event-modal-label" } },
        [_vm._v("Detail Event")]
      ),
      _vm._v(" "),
      _c(
